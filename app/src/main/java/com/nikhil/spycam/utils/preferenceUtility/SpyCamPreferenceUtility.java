package com.nikhil.spycam.utils.preferenceUtility;
...
public class SpyCamPreferenceUtility {
    ...
    /**
     * @return : true if camera preview is enable
     */
    ...
    /**
     * This method save the state of camera preview
     * @param enabled : to check if preview is enable or not
     */
    ...
    /**
     * @return : camera quality in which video should be recorded
     */
    ...
    /**
     * save the state of camera quality
     * @param quality
     */
    ...
    public void setMaxDuration(int maxDuration) {
        mEditor.putInt(MAX_DURATION, maxDuration);
        mEditor.commit();
    }
    ...
    public void setMaxSize(int maxSize) {
        mEditor.putInt(MAX_SIZE, maxSize);
        mEditor.commit();
    }
